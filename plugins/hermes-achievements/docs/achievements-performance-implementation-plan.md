# AgentX Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.agentx/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.agentx/plugins/hermes-achievements/scan_checkpoint.json`.
