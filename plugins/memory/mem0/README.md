...
```json
{
  ...
  "oss": {
    ...
    "vector_store": {"provider": "qdrant", "config": {"path": "~/.agentx/mem0_qdrant"}}
  }
}
```
...
- Check `user_id` matches between sessions (`$AGENTX_HOME/mem0.json`).
