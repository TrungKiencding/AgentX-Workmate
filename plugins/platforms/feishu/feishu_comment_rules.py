...
Config: ~/.agentx/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.agentx/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (AGENTX_HOME-aware and
