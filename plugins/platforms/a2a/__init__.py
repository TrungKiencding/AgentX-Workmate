"""
A2A (Agent-to-Agent) plugin for AgentX Workmate.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes AgentX as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`agentx gateway setup` flow for A2A."""
    ...
    print_info("Expose AgentX as an A2A-discoverable agent and call other A2A agents.")
