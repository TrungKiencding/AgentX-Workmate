...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⬡ *AgentX Workmate*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    # Try AGENTX_HOME location first
    ...
    # Install dir is read-only, mirror to AGENTX_HOME if needed
    if hermes_home_bridge.exists():
        return hermes_home_bridge

    # Mirror the bridge source to AGENTX_HOME
    try:
