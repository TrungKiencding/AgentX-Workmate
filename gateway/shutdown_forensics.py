...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded agentx-agent but never re-ran ``agentx setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../agentx-gateway.service"
    ...
    # that's the common case for agentx.
