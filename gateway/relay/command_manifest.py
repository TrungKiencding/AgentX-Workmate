...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your AgentX session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show AgentX session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running AgentX agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update AgentX Workmate to the latest version"},
        {"name": "restart", "description": "Gracefully restart the AgentX gateway"},
        {
            "name": "approve",
