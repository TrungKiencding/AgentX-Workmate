...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (AgentX-config directed, relay-namespaced):
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack AgentX already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # AgentX suppresses this synthetic DM thread anchor; drop it here for the
