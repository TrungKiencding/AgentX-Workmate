...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating AgentX' : 'Setting up AgentX Workmate'

  const description = isUpdate
    ? 'AgentX is updating to the latest version — this only takes a moment.'
  ...
  return (
    <div className="agentx-fade-in flex h-full flex-col">
