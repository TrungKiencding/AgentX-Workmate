...
cd apps/desktop
XCURSOR_SIZE=24 AGENTX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/agentx-typing
# → /tmp/agentx-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/agentx-typing.before.heapsnapshot
# → /tmp/agentx-typing.after.heapsnapshot
```
