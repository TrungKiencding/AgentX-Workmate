...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\agentx\agentx-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@agentx/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@agentx/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@agentx/shared': path.resolve(__dirname, '../shared/src'),
