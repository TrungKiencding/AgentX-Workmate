 ...
 * `<agentx home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'agentx.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'agentx.desktop.disabledPlugins.v1'
