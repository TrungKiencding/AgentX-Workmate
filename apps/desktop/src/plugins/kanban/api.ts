...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@agentx/plugin-sdk'
...
/** First-class AgentX projects, for scoping a board's default workspace. */
