...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@agentx/plugin-sdk'
...
const vi: KanbanMessages = {
  nav: 'Kanban',
  openBoard: 'Kanban: Mở bảng',
  newTaskCommand: 'Kanban: Thẻ việc mới',
  countTip: (running, ready) => `Kanban — ${running} đang chạy, ${ready} sẵn sàng`,
  col: {
    triage: { label: 'Phân loại', help: 'Ý tưởng thô — một agent chuyên tả sẽ viết thành đặc tả đầy đủ.' },
    todo: { label: 'Cần làm', help: 'Đang chờ việc phụ thuộc, hoặc chưa giao cho ai.' },
    scheduled: { label: 'Đã hẹn giờ', help: 'Đang chờ tới giờ đã hẹn.' },
    ready: { label: 'Sẵn sàng', help: 'Đã đủ điều kiện — gán một hồ sơ là bộ điều phối sẽ chạy nó.' },
    running: { label: 'Đang chạy', help: 'Một worker đã nhận — có agent đang làm. Do bộ điều phối đặt.' },
    blocked: { label: 'Đang vướng', help: 'Worker đang cần con người trả lời.' },
    review: { label: 'Đang duyệt', help: 'Một agent duyệt đang kiểm tra kết quả. Do bộ điều phối đặt.' },
    done: { label: 'Xong', help: 'Đã hoàn tất; các thẻ con phụ thuộc chuyển sang sẵn sàng.' },
    archived: { label: 'Đã lưu trữ', help: 'Ẩn khỏi khung nhìn mặc định của bảng.' }
  },
  locked: {
    review: 'Cột Đang duyệt do bộ điều phối đặt khi một agent duyệt nhận thẻ.',
    running: 'Cột Đang chạy do bộ điều phối đặt khi một worker nhận thẻ.',
    scheduled: 'Cột Đã hẹn giờ cần có mốc thời gian — agent đặt mốc đó; bạn không kéo thẻ vào đây được.'
  },
  arcRunning: 'Một agent đang làm việc này ngay lúc này.',
  arcStale: 'Đã có worker nhận, nhưng hơn 2 phút không thấy tín hiệu — bộ điều phối sẽ thu lại thẻ.',
  title: 'Kanban',
  orchestrationSettings: 'Cài đặt điều phối',
  newTask: 'Thẻ việc mới',
  filterCards: 'Lọc thẻ…',
  noMatch: 'Không có thẻ nào khớp bộ lọc',
  noTasks: 'Bảng này chưa có thẻ nào',
  open: 'Mở',
  select: 'Chọn (⌘-nhấp)',
  deselect: 'Bỏ chọn',
  moveTo: label => `Chuyển sang ${label}`,
  delete: 'Xoá',
  reviewChecking: 'Một agent duyệt đang kiểm tra phần việc đã hoàn tất.',
  attachedTip: name => `Đã gắn ${name} — bộ điều phối sẽ bàn giao ở nhịp kế tiếp (dưới 1 phút).`,
  orchestratorTip: name => `${name} (bộ điều phối) sẽ nhận thẻ này ở nhịp kế tiếp và viết đặc tả.`,
  autoAssignTip: name => `Sẽ tự gán cho “${name}” (kanban.default_assignee) ở nhịp điều phối kế tiếp.`,
  wontRun: 'sẽ không chạy',
  wontRunTip:
    'Thẻ ở cột Sẵn sàng chỉ chạy khi đã gán hồ sơ. Hãy mở thẻ và chọn người nhận, hoặc đặt người nhận mặc định trong cài đặt điều phối.',
  noHeartbeat: 'không có tín hiệu',
  expand: label => `Mở rộng ${label}`,
  collapse: label => `Thu gọn ${label}`,
  newTaskIn: label => `Thẻ việc mới trong ${label}`,
  empty: 'Trống',
  unassigned: 'chưa giao',
  filters: 'Bộ lọc',
  allProfiles: 'Mọi hồ sơ',
  allTenants: 'Mọi tenant',
  showArchived: 'Hiện thẻ đã lưu trữ',
  groupRunning: 'Nhóm cột Đang chạy theo hồ sơ',
  nSelected: n => `Đã chọn ${n}`,
  moveToShort: 'Chuyển sang',
  assign: 'Giao việc',
  unassignAction: 'Bỏ giao',
  archive: 'Lưu trữ',
  clearSelection: 'Bỏ chọn tất cả (Esc)',
  refused: 'bị từ chối',
  bulkFailed: (failed, total, err) => `${failed} trên ${total} thất bại — ${err}. Các thẻ lỗi vẫn được giữ chọn.`,
  titlePlaceholderTriage: 'Ý tưởng thô — sẽ có agent viết lại thành đặc tả',
  titlePlaceholder: 'Tiêu đề',
  descPlaceholder: 'Mô tả (không bắt buộc)',
  priority: 'Độ ưu tiên',
  workspace: 'Workspace',
  boardDefaultSuffix: ' · mặc định của bảng',
  workspaceOverride: 'Đường dẫn workspace (ghi đè, không bắt buộc)',
  model: 'Model',
  modelInherit: 'Mặc định của hồ sơ',
  modelClear: 'Bỏ ghi đè model',
  modelHint: 'Chạy thẻ này trên một model và mức suy nghĩ cụ thể. Để trống thì dùng thiết lập của hồ sơ được gán.',
  workspaceInherit: 'Kế thừa thư mục dự án của bảng',
  workspaceInheritDir: dir => `Để trống để kế thừa ${dir}`,
  workspaceInheritGeneric: 'Để trống để kế thừa thư mục dự án của bảng.',
  assignee: 'Người nhận',
  defaultOption: name => `${name} (mặc định)`,
  parkedOption: 'chưa giao (để treo — sẽ không chạy)',
  skills: 'Kỹ năng (cách nhau bằng dấu phẩy)',
  skillsPlaceholder: 'translation, github',
  parent: 'Thẻ cha (chặn cho tới khi thẻ đó xong)',
  noParent: '— không có thẻ cha —',
  goalMode: 'Chế độ mục tiêu (worker lặp cho tới khi một agent thẩm định đồng ý là xong)',
  creating: 'Đang tạo…',
  createTask: 'Tạo thẻ việc',
  cancel: 'Huỷ',
  save: 'Lưu',
  estimate: 'Ước lượng',
  estimateEffort: 'Ước lượng công sức',
  estimating: 'Đang ước lượng…',
  reEstimate: 'Ước lượng lại',
  makesModelCall: 'có gọi model',
  estimateTip: 'Ước lượng nhanh số token + độ phức tạp bằng model phụ trợ — thao tác này có gọi model.',
  estimateTipLong:
    'Chạy một lời gọi nhanh tới model phụ trợ để ước lượng token + độ phức tạp. Chỉ mang tính tham khảo, không phải hoá đơn.',
  roughEstimate: 'Ước lượng sơ bộ',
  tokUnit: 'token',
  couldNotEstimate: 'Không ước lượng được',
  complexity: { S: 'Nhỏ', M: 'Vừa', L: 'Lớn' },
  introBody:
    'Bạn không phải người chạy các thẻ — agent làm việc đó. Đưa một thẻ vào cột Sẵn sàng kèm người nhận là trong vòng một phút sẽ có agent nhận. Không có người nhận thì không chạy. Phân loại: một agent viết lại ý tưởng thành đầu việc đàng hoàng trước. Cần làm: đang chờ các thẻ khác. Đã hẹn giờ: đang chờ tới giờ. Đang chạy và Đang duyệt: sân của agent, bạn không cần đụng vào. Đang vướng: nó đang chờ bạn. Kết quả sẽ hiện ngay trên thẻ.',
  introGotIt: 'Đã hiểu',
  evtCreated: (where, assignee) =>
    `đã tạo${where ? ` trong ${where}` : ''}${assignee ? ` · giao cho ${assignee}` : ''}`,
  evtMovedTo: col => `chuyển sang ${col}`,
  evtParentReopened: parent => `thẻ cha ${parent} đã mở lại`,
  evtAssignedTo: assignee => `giao cho ${assignee}`,
  evtUnassigned: 'đã bỏ giao',
  evtCommentBy: author => `bình luận của ${author}`,
  evtClaimedReview: 'một agent duyệt đã nhận',
  evtClaimedWorker: 'một worker đã nhận',
  evtWorkerStarted: 'worker đã bắt đầu',
  evtCompleted: 'đã hoàn tất',
  evtBlocked: 'đang vướng — cần con người trả lời',
  evtUnblocked: col => `đã gỡ vướng${col ? ` → ${col}` : ' → Sẵn sàng'}`,
  evtReclaimed: 'đã thu lại — trả về hàng chờ',
  evtSpecified: 'đặc tả do agent phân loại viết',
  evtPromoted: 'các phụ thuộc đã xong — chuyển lên Sẵn sàng',
  evtScheduled: 'đã hẹn giờ chạy sau',
  evtArchived: 'đã lưu trữ',
  evtReprioritized: priority => `đặt độ ưu tiên thành ${priority}`,
  someone: 'ai đó',
  metaPriority: 'Độ ưu tiên',
  metaTenant: 'Tenant',
  metaCreatedBy: 'Người tạo',
  metaCreated: 'Ngày tạo',
  metaWorkerPid: 'Pid của worker',
  readyUnassignedTitle: 'Sẵn sàng nhưng chưa giao cho ai — thẻ này sẽ không bao giờ chạy.',
  readyUnassignedBody:
    'Bộ điều phối chỉ nhận những thẻ Sẵn sàng đã có người nhận. Hãy chọn một hồ sơ ở ô Người nhận bên trên (hoặc đặt người nhận mặc định trong cài đặt điều phối) là nó sẽ chạy trong vòng một phút.',
  diagnosticsN: n => `Chẩn đoán · ${n}`,
  ...
  result: 'Kết quả',
  latestSummary: 'Tóm tắt mới nhất',
  dependencies: 'Phụ thuộc',
  blockedBy: 'Bị chặn bởi',
  blocks: 'Đang chặn',
  comments: n => `Bình luận · ${n}`,
  commentsHelpRunning:
    'Thẻ này đang chạy. Ghi chú của bạn sẽ được đưa vào lượt hiện tại của worker trong vài giây — không cần chặn rồi gỡ chặn. Còn “Đưa lại hàng chờ kèm ghi chú” thì cho chạy lại thẻ từ đầu với ghi chú của bạn trong ngữ cảnh.',
  commentsHelp:
    'Bình luận được thêm vào luồng của thẻ. Khi một worker nhận thẻ, nó sẽ đọc các bình luận này như một phần ngữ cảnh.',
  send: 'Gửi',
  comment: 'Bình luận',
  messageWorker: 'Nhắn cho worker đang chạy…',
  addComment: 'Thêm bình luận…',
  deliveredLive: 'Đã chuyển tới worker đang chạy trong vài giây.',
  requeueWithNote: 'Đưa lại hàng chờ kèm ghi chú',
  notePosted: 'Đã đăng ghi chú — thẻ được đưa lại hàng chờ',
  activity: n => `Hoạt động · ${n}`,
  runs: n => `Lượt chạy · ${n}`,
  workerLog: 'Log của worker',
  workerLogTail: 'Log của worker · phần cuối',
  attachments: n => `Tệp đính kèm · ${n}`,
  noAttachments: 'Chưa có tệp đính kèm nào.',
  uploadAttachment: 'Tải tệp đính kèm lên',
  taskActions: 'Thao tác với thẻ',
  copyTaskId: 'Sao chép id thẻ',
  copyTitle: 'Sao chép tiêu đề',
  copiedId: id => `Đã sao chép ${id}`,
  copiedTitle: 'Đã sao chép tiêu đề',
  archiveTask: 'Lưu trữ thẻ',
  deleteTask: 'Xoá thẻ',
  close: 'Đóng',
  working: 'đang làm',
  board: 'Bảng',
  newBoard: 'Bảng mới',
  newBoardDots: 'Bảng mới…',
  boardSettings: 'Cài đặt bảng…',
  boardSettingsFor: name => `Cài đặt bảng — ${name}`,
  name: 'Tên',
  boardNamePlaceholder: 'Tên bảng',
  slug: slug => `slug: ${slug}`,
  project: 'Dự án',
  noProject: 'Không thuộc dự án nào (sandbox tạm)',
  projectHintPre:
    'Thẻ mới sẽ chạy trong repo của dự án (mỗi thẻ một worktree); từng thẻ vẫn có thể tự chọn workspace riêng lúc tạo. Quản lý dự án bằng ',
  projectHintCmd: 'agentx project',
  createBoard: 'Tạo bảng',
  orchestratorProfile: 'Hồ sơ điều phối',
  defaultAssignee: 'Người nhận mặc định',
  defaultParen: '(mặc định)',
  autoDecompose: 'Tự động tách nhỏ thẻ ở cột Phân loại',
  profileDescriptions: 'Mô tả hồ sơ',
  profileDescriptionsHint:
    'Phần mô tả giúp bộ tách việc định tuyến đúng chỗ. Bạn có thể tự sinh bằng model phụ trợ, hoặc tự viết.',
  profileGoodAt: 'Hồ sơ này giỏi việc gì?',
  auto: 'Tự động'
}

/** Registered via `ctx.i18n.register` at plugin load (disposer tracked). */
export const KANBAN_LOCALES: PluginLocaleBundles = { vi, en, ja, zh, 'zh-hant': zhHant }
