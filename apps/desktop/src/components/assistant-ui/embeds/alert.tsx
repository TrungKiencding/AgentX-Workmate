...
// GitHub's five alert kinds, mapped to our icon set + a semantic tone — the
// tokens move with the theme, a fixed Tailwind ramp would not.
const ALERT_STYLES: Record<AlertType, AlertStyle> = {
  caution: { accent: 'text-destructive', icon: AlertTriangle, label: 'Caution' },
