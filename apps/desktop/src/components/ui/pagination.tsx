...
function PaginationButton({ className, isActive, ...props }: PaginationButtonProps) {
  return (
    <button
      ...
      className={cn(
        'inline-flex h-5 min-w-5 items-center justify-center rounded border border-transparent px-1 text-2xs leading-none tabular-nums transition-colors disabled:pointer-events-none disabled:opacity-45',
        isActive
...
function PaginationPrevious({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex h-5 items-center justify-center gap-0.5 rounded border border-transparent px-1 text-2xs leading-none text-muted-foreground transition-colors hover:bg-accent hover:text-foreground disabled:pointer-events-none disabled:opacity-45',
        className
      )}
