...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-(--dur-short) ease-in-out',
      ...
      <div
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-(--dur-short) ease-in-out md:flex',
          side === 'left'
  ...
  return (
    <Tip label={label}>
      <button
        aria-label={label}
        className={cn(
          'absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-[left,right,width,background-color] ease-in-out group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[0.125rem] hover:after:bg-sidebar-border sm:flex',
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      className={cn(
        'flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-(--dur-short) ease-in-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
