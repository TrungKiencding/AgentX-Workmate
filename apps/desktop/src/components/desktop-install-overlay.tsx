 ...
 *
 * Renders the first-launch install progress for AgentX Workmate. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  // there's no AgentX Workmate installed yet and we can't drive install.sh
      ...
      <div className="fixed inset-0 z-(--z-setup) flex items-center justify-center bg-background/90 backdrop-blur-md">
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-nous) bg-card p-8 shadow-nous">
          ...
          <div className="mt-4">
            ...
            <pre className="overflow-x-auto rounded-md border border-(--stroke-nous) px-3 py-2.5 font-mono text-xs">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.agentxDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.agentxDesktop?.cancelBootstrap?.()
                  } catch {
              ...
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.agentxDesktop?.resetBootstrap?.()
                    } catch {
