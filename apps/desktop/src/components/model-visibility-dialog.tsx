              ...
              return (
                <div className="py-0.5" key={provider.slug}>
                  <div className="flex items-center gap-2 px-3 pb-0.5 pt-1">
                    <button
                      className="group/label flex w-full items-center gap-1 pb-0.5 pt-0.5 text-left text-2xs font-medium uppercase tracking-label text-(--ui-text-tertiary) hover:bg-transparent"
