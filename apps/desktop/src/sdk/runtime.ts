 ...
 * plugins resolve `@agentx/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __AGENTX_PLUGIN_SDK__: sdk,
  __AGENTX_REACT__: React,
  __AGENTX_REACT_JSX__: jsxRuntime,
  __AGENTX_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@agentx/plugin-sdk': shimUrl('__AGENTX_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__AGENTX_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__AGENTX_REACT_JSX__'),
    react: shimUrl('__AGENTX_REACT__')
  }
