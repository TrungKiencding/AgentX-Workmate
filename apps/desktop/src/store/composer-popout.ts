...
const POPOUT_STORAGE_KEY = 'agentx.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'agentx.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'agentx.desktop.composerPopout.position'
