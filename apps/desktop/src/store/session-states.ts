...
const TILES_KEY = 'agentx.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'agentx.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __AGENTX_LAYOUT_TREE__).
