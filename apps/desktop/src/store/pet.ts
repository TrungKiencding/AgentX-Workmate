...
export interface PetInfo {
  ...
  // the AgentX "run" activity state uses the in-place running row).
 ...
 * AGENTX_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'agentx.desktop.pet-roam.v1'
