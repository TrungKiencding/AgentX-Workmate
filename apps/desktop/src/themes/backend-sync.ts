/**
 * Live skin sync from the AgentX backend.
 *
 * The backend resolves the active skin (built-in or `$AGENTX_HOME/skins/*.yaml`)
 ...
 * stomps the user's persisted desktop theme; only a genuine name change (AgentX
