/**
 * AgentX skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$AGENTX_HOME/skins/` (or a
 ...
 * skin AgentX authors from a prompt lights up all three surfaces from one file.
 *
...
import type { HermesSkin, SkinColors } from '@agentx/shared/skin'
