...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: '这会从 AgentX 中移除已保存的项目。文件、git 仓库和工作树保持不变。',
      startWork: '新建工作树',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.agentx/config.yaml)。AgentX 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: '等待网关超时。`agentx gateway` 是否正在运行？'
    }
  },
