...
export const zh: Translations = {
  ...
  skills: {
    ...
    hub: {
      storeTitle: 'AgentX 工具商店',
      actions: '操作',
      searchPlaceholder: '搜索工具商店',
      search: '搜索',
      searching: '搜索中…',
      connectingHubs: '正在连接工具商店…',
      featured: '精选',
      landingHint: '搜索商店，浏览可以为 AgentX 加装的实用工具。',
      catalogCount: count => `来自 Hub 的 ${count} 个工具`,
      catalogEmpty: '尚未从 Hub 同步到任何工具。',
      ...
      noInstalls: '本机尚未收到来自 Hub 的安装请求。在 Hub 上点击“安装”即可送达此处。',
