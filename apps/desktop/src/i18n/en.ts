...
export const en: Translations = {
  ...
  skills: {
    ...
    noToolsetsTitle: 'No tools found',
    ...
    toolsetsEnabled: (enabled, total) => `${enabled}/${total} tools enabled`,
    ...
    toolsetsRefreshFailed: 'Tools failed to refresh',
    ...
    hub: {
      storeTitle: 'AgentX utility store',
      actions: 'Actions',
      searchPlaceholder: 'Search the utility store',
      search: 'Search',
      searching: 'Searching...',
      connectingHubs: 'Connecting to the utility store...',
      featured: 'Featured',
      landingHint: 'Search the store to browse utilities you can add to AgentX.',
      catalogCount: count => `${count} ${count === 1 ? 'utility' : 'utilities'} from the Hub`,
