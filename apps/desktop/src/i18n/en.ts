...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a AgentX backend elsewhere. Per-profile overrides below.',
  ...
  install: {
    ...
    setupChoiceDesc:
      'Connect this app to a AgentX gateway you already run, or install AgentX locally on this computer.',
