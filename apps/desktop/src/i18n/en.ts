...
export const en: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from AgentX. Files, git repos, and worktrees stay untouched.',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.agentx/config.yaml). AgentX won’t ask again for commands like this — in this session or any future one.`,
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `agentx gateway` running?'
    }
  },
