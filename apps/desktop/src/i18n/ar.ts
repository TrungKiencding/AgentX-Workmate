...
export const ar = defineLocale({
  ...
  boot: {
    ...
    phases: {
      ...
      repin: 'يجري تحديث تثبيت AgentX إلى الإصدار المرفق مع هذا الإصدار من التطبيق',
  ...
  settings: {
    ...
    mcp: {
      mcpIntro: 'اربط AgentX ببرامج أخرى عبر معيار MCP. مخصص للمسؤولين.',
      addConnection: 'إضافة اتصال',
      addFromCatalog: 'من الكتالوج',
      addPasteConfig: 'لصق إعداد',
      advancedConfig: 'الإعداد المتقدم (mcp.json)',
      backToConnections: 'كل الاتصالات',
      logsTitle: 'السجلات',
  ...
  skills: {
    pageTitle: 'الأدوات المساعدة',
    pageDescription: 'ما يستطيع AgentX فعله لك. شغّل ما تحتاجه وأطفئ ما لا تستخدمه.',
    tabSkills: 'المهارات المتاحة',
    tabToolsets: 'الأدوات',
    tabMcp: 'اتصالات متقدمة',
    tabHub: 'متجر المهارات',
    nounSkills: 'مهارات',
    nounTools: 'أدوات',
    ...
    category: {
      apple: 'Apple',
      'autonomous-ai-agents': 'مساعدون تلقائيون',
      creative: 'إبداع',
    ...
    toggleSkill: (name, enabled) => `${enabled ? 'تشغيل' : 'إيقاف'} ${name}`,
    ...
    hub: {
      storeTitle: 'متجر مهارات AgentX',
      actions: 'الإجراءات',
      searchPlaceholder: 'ابحث في متجر المهارات',
      searching: 'جارٍ البحث...',
      catalogCount: count => `${count} ${count === 1 ? 'مهارة' : 'مهارات'} من Hub`,
      ...
      noResults: 'لم يُعثر على مهارات مطابقة في المتجر.',
      resultCount: (count, ms) =>
        `${count} ${count === 1 ? 'نتيجة' : 'نتائج'}${ms !== null ? ` خلال ${ms} مللي ثانية` : ''}`,
      installed: 'مُضافة',
      install: 'إضافة هذه المهارة',
      uninstall: 'إزالة هذه المهارة',
      ...
      installStarted: name => `جارٍ إضافة ${name}...`,
  ...
  messaging: {
    ...
    showMorePlatforms: count => `عرض ${count} منصات أخرى`,
    step1Title: 'أنشئ البوت واحصل على الصلاحية',
    step2Title: 'الصق المفاتيح',
    step3Title: 'شغّل الاتصال',
    step3Enable: name => `شغّله ليبدأ AgentX باستقبال الرسائل من ${name}.`,
    stepDone: 'تم',
    restartNow: 'إعادة تشغيل AgentX',
    recommendedCount: count => `موصى به (${count})`,
    wantsToMessage: (name, platform) => `«${name}» يريد مراسلة AgentX عبر ${platform}`,
    allow: 'سماح',
    search: 'بحث',
    loading: 'جار التحميل...',
    ...
    destinationTitle: 'عنوان المحادثة',
    destinationUnavailable: 'تم الاتصال، لكن المنصة لا توفر عنوانا عاما.',
    openDestination: 'فتح في التطبيق',
    viewOnly: 'للعرض فقط',
    viewOnlyTitle: platform => `متابعة المحادثة من ${platform}`,
    viewOnlyHint: platform => `تابع الرد في ${platform}؛ يعرض Workmate التقدم هنا فقط.`,
  ...
  artifacts: {
    ...
    emptyDesc: 'عندما ينشئ AgentX صورة أو ملفًا لك، سيظهر هنا.',
    emptyAction: 'ابدأ محادثة',
    noResultsTitle: 'لا توجد نتائج',
    noResultsDesc: 'لا يوجد ما يطابق عامل التصفية الحالي.',
    clearSearch: 'مسح البحث',
    showAll: 'عرض الكل',
    pageTitle: 'العناصر',
    pageDescription: 'الصور والملفات والروابط التي أنشأها AgentX في محادثاتك.',
    ...
    groupToday: 'اليوم',
    groupYesterday: 'أمس',
    groupLast7Days: 'آخر 7 أيام',
    open: 'فتح',
    viewChat: 'عرض المحادثة',
    rowActions: 'إجراءات أخرى',
    copyUrl: 'نسخ الرابط',
    copyPath: 'نسخ المسار'
  },
  ...
  install: {
    ...
    updatingTitle: 'جار تحديث AgentX Workmate',
    updatingDesc:
      'هذا الإصدار من التطبيق أحدث من وكيل AgentX المثبّت على هذا الجهاز. يقوم المثبّت بتحديث الوكيل إلى الإصدار المطابق؛ وتبقى إعداداتك ومحادثاتك ومفتاح النموذج كما هي.',
