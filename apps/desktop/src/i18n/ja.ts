...
export const ja = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingAgentxDesktop: 'AgentX Workmate Desktop を起動中…'
    },
    errors: {
      backgroundExited: 'AgentX バックグラウンドプロセスが終了しました。',
      backgroundExitedDuringStartup: '起動中に AgentX バックグラウンドプロセスが終了しました。',
  ...
  notifications: {
    ...
    native: {
      ...
      rejectAction: '拒否',
      inputTitle: '入力が必要です',
      inputBody: 'AgentX が応答を待っています。',
      turnDoneTitle: 'AgentX が完了しました',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'すべての設定を AgentX のデフォルトに戻しますか？',
    ...
    account: {
      ...
      keyUnconfigured: 'このインストールにはモデルサービスが設定されていません。AgentX の管理者に連絡してください。',
      keyOffline: 'モデルプロキシに接続できませんでした。既存のキーは引き続き使えます。',
      keyRevoked: 'このデバイスは失効しました。もう一度サインインしてください。',
      keyRotate: '新しいキーを発行',
      ...
      devicesEmptyDesc: 'このマシンは次回 AgentX Workmate を起動したときにここに表示されます。',
      deviceCurrent: 'このデバイス',
      deviceUnnamed: '名前のないデバイス',
      deviceRevoked: '失効済み',
      deviceRevoke: 'デバイスを失効',
      deviceRevokeConfirmTitle: 'このデバイスを失効しますか？',
      deviceRevokeConfirmDesc: name =>
        `${name} は AgentX からサインアウトされ、再び使うにはサインインし直す必要があります。`,
      deviceRotateKey: 'モデルキーも新しく発行する',
      deviceRotateKeyDesc:
        'デバイス間で 1 つのモデルキーを共有しているため、失効させるだけではそのデバイスのモデルアクセスは残ります。他のデバイスは新しいキーを自動で受け取ります。',
      deviceRevokedWithKey: 'デバイスを失効し、新しいモデルキーを発行しました。',
      deviceRevokedWithoutKey:
        'デバイスを失効しました。手元のモデルキーはそのまま使えます。アクセスも断つには、新しいキーを発行して再度失効してください。',
      deviceRevokeFailed: 'そのデバイスを失効できませんでした。',
      deviceRevokeLastError:
        'これはアカウントに残った唯一のデバイスです。ここで新しいキーを発行すると、受け取れるマシンがなくなります。先に別のマシンでサインインするか、新しいキーを発行せずに失効してください。',
      deviceRevokedSelf: 'このデバイスは失効しています。使い続けるにはサインインし直してください。',
      deviceOffline: 'AgentX アカウントサービスに接続できませんでした。デバイスの状態は変わっていません。',
      deviceUnconfigured: 'このインストールは AgentX アカウントサービスに接続されていません。',
      deviceLastSeenNow: '現在アクティブ',
      deviceLastSeenUnknown: '最終利用時刻は不明',
      deviceLastSeenMinutes: n => `${n} 分前に利用`,
      deviceLastSeenHours: n => `${n} 時間前に利用`,
      deviceLastSeenDays: n => `${n} 日前に利用`,
      syncTitle: '会話履歴',
      syncUpToDate: '他のデバイスと同期しています。',
      syncPending: n => `他のデバイスへ送信待ちの変更が ${n} 件あります。`,
      syncPendingPill: n => `${n} 件待機`,
      syncOffline:
        'AgentX アカウントサービスに接続できませんでした。作業はこの端末に保存され、後で自動的に同期されます。',
      syncError: '前回の同期がサービスに拒否されました。まもなく再試行します。',
      ...
      syncNever: 'まだありません',
      syncJustNow: 'たった今',
      syncMinutesAgo: n => `${n} 分前`,
      syncHoursAgo: n => `${n} 時間前`,
      syncDaysAgo: n => `${n} 日前`
    },
    notifications: {
      title: '通知',
      ...
      focusedHint: '完了通知は AgentX がバックグラウンドにあるときのみ表示されます。',
      kinds: {
        approval: {
          label: '承認が必要',
        ...
        input: {
          label: '入力が必要',
          description: 'AgentX が質問したか、パスワードやシークレットを必要としています。'
        },
        turnDone: {
          label: '応答完了',
          description: 'AgentX がバックグラウンドのときにターンが完了しました。'
        },
        turnError: {
          label: 'ターン失敗',
        ...
        plugin: {
          label: 'プラグイン通知',
          description: 'AgentX がバックグラウンドの間に、デスクトッププラグインが通知を送信しました。'
        }
      },
      test: 'テスト通知を送信',
      testTitle: 'AgentX',
    ...
    searchPlaceholder: {
      about: 'AgentX Workmate Desktop について',
      config: '設定を検索…',
      gateway: 'ゲートウェイ接続…',
      keys: 'API キーを検索…',
      mcp: 'MCP サーバーを検索…',
    ...
    customEndpoints: {
      title: 'カスタムエンドポイント',
      loadError: 'カスタムエンドポイントを読み込めませんでした',
      saved: 'カスタムエンドポイントを保存しました。',
      saveError: '保存に失敗しました',
      reachable: 'エンドポイントに接続できました。',
      reachableWithModels: (count: number) => `エンドポイントに接続できました。${count}件のモデルが見つかりました。`,
      validationFailed: 'エンドポイントの検証に失敗しました。',
      validateError: '検証に失敗しました',
      ...
      emptyDesc: '下のフォームからOpenAI互換のエンドポイントを追加してください。',
      editHeading: 'エンドポイントを編集',
      addHeading: 'エンドポイントを追加',
      nameLabel: '名前',
      providerIdLabel: 'プロバイダーID',
      urlLabel: 'エンドポイントURL',
      modelLabel: 'デフォルトモデル',
      contextLabel: 'コンテキスト',
      apiKeyLabel: 'APIキー',
      keepKeyPlaceholder: '空欄で現在のキーを維持',
    ...
    appearance: {
      ...
      accentTitle: 'アクセント',
      accentDesc: 'Nousテーマのブルーを置き換えます — ボタン、フォーカスリング、選択色。他のテーマには影響しません。',
      accentNames: {
        nousBlue: 'Nousブルー',
        violet: 'バイオレット',
        magenta: 'マゼンタ',
      ...
      colorMode: 'カラーモード',
      colorModeDesc: '固定モードを選ぶか、AgentX をシステム設定に合わせます。',
      ...
      pet: {
        title: 'ペット',
        intro:
          'アプリ上に浮かぶ petdex のアニメーションマスコットを採用しましょう。ツール実行中は走り、成功すると喜び、エラーでしょんぼりと、AgentX の状態に反応します。',
        restartHint:
          'ペット機能には再起動が必要です。この機能が追加される前に起動したアプリが動作中です。AgentX を終了して再度開き、このページに戻ってください。',
        scaleTitle: 'サイズ',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone:
        'AgentX がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
        imageInputMode: '画像添付をモデルへ送る方法を制御します。',
        maxTurns: 'AgentX が 1 回の実行を停止するまでのツール呼び出しターン上限です。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'AgentX が 1 回のファイル読み取りで取得できる最大文字数です。',
      approvals: {
        mode: '明示的な承認が必要なコマンドを AgentX がどう扱うかを設定します。',
    ...
    quickEntry: {
      enabledTitle: 'クイック入力',
      enabledDesc:
        'グローバルショートカットで小さな入力欄をどこからでも呼び出し、AgentX を開かずにプロンプトを送信します。',
    ...
    gateway: {
      ...
      intro:
        'AgentX Workmate Desktop はデフォルトで独自のローカルゲートウェイを起動します。別のマシンや信頼できるプロキシの背後で既に動作している AgentX バックエンドをこのアプリで制御する場合は、リモートゲートウェイを使用してください。以下でプロファイルを選択して、それぞれのリモートホストを設定します。',
      appliesTo: '適用対象',
      ...
      envOverrideDesc:
        '保存された設定を使用するには AGENTX_DESKTOP_REMOTE_URL と AGENTX_DESKTOP_REMOTE_TOKEN の設定を解除してください。',
      localTitle: 'ローカルゲートウェイ',
      localDesc:
        'ローカルホストでプライベートな AgentX バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
      inheritTitle: 'デフォルトゲートウェイを使用',
      inheritDesc: 'このプロファイルのオーバーライドを削除し、デフォルト接続を使用します。',
      remoteTitle: 'リモートゲートウェイ',
      remoteDesc:
        'このデスクトップシェルをリモートの AgentX バックエンドに接続します。ホスト型ゲートウェイは OAuth またはユーザー名とパスワードを使用します。自己ホスト型はセッショントークンを使用する場合があります。',
      remoteUrlTitle: 'リモート URL',
      remoteUrlDesc:
        'リモートダッシュボードバックエンドのベース URL。/agentx などのパスプレフィックスもサポートしています。',
      ...
      restartingMessage: 'AgentX Workmate Desktop は保存された設定を使用して再接続します。',
      savedMessage: '次回起動時に保存されます。',
      connectedTo: (baseUrl, version) => `${baseUrl}${version ? ` · AgentX ${version}` : ''} に接続しました`,
      ...
      sshTitle: 'SSH で接続',
      sshDesc:
        'AgentX は SSH 経由でリモート上に起動され、このアプリにトンネルされます。リモート側で何かを起動・公開する必要はありません。ホストへの鍵ベースの SSH アクセスが前提です。',
      ...
      sshHermesPathTitle: 'AgentX パス（任意）',
      sshHermesPathDesc: 'リモートの agentx バイナリへのフルパス。空欄 = 自動検出。',
      ...
      sshReachable: (host, platform) => `接続可能: ${host}（${platform}）— AgentX を検出`,
      sshIncompleteHost: '接続する前に SSH ホストを入力してください。',
      sshErrUnreachable: 'SSH でそのホストに到達できませんでした。ホスト、ポート、ネットワークを確認してください。',
      sshErrAuth:
        'SSH 認証に失敗しました。鍵を ssh-agent に読み込む（ssh-add）か、~/.ssh/config に IdentityFile を設定してください。AgentX は非対話的に ssh を実行します。',
      sshErrHostKey:
        '前回の接続以降、ホスト鍵が変更されています。想定どおりか確認し、ssh-keygen -R <host> を実行してから再接続してください。',
      sshErrNotInstalled:
        'リモートホストに AgentX がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/TrungKiencding/AgentX-Workmate/main/scripts/install.sh | sh）か、AgentX パスを設定してください。',
      sshErrPlatform:
        'サポートされていないリモートプラットフォームです。AgentX Workmate Desktop の SSH モードは Linux、macOS、Windows のリモートホストに対応しています。',
      sshErrTimeout: 'SSH 接続がタイムアウトしました。ホストが到達不能、またはスリープ中の可能性があります。',
      sshErrUpdateRequired: 'Desktop SSH で接続する前に、リモートホストの AgentX を更新してください。',
    ...
    mcp: {
      mcpIntro: 'MCP 標準で AgentX を他のソフトウェアにつなぎます。管理者向け。',
      addConnection: '接続を追加',
      addFromCatalog: 'カタログから',
      addPasteConfig: '設定を貼り付け',
      advancedConfig: '高度な設定 (mcp.json)',
      backToConnections: 'すべての接続',
      logsTitle: 'ログ',
    ...
    providers: {
      ...
      intro:
        'サブスクリプションでサインインします。API キーのコピーは不要です。AgentX がアプリ内でブラウザーサインインを代行します。',
      connected: '接続済み',
      collapse: '折りたたむ',
  ...
  skills: {
    pageTitle: 'ユーティリティ',
    pageDescription: 'AgentX にできること。必要なものはオン、使わないものはオフに。',
    tabSkills: '利用できるスキル',
    tabToolsets: 'ツール',
    tabMcp: '高度な連携',
    tabHub: 'スキルストア',
    ...
    toggleSkill: (name, enabled) => `${name} を${enabled ? 'オン' : 'オフ'}にする`,
    ...
    hub: {
      storeTitle: 'AgentX スキルストア',
      actions: '操作',
      searchPlaceholder: 'スキルストアを検索',
      searching: '検索中...',
      catalogCount: count => `Hub から ${count} 個のスキル`,
      catalogEmpty: 'まだ Hub から同期されたスキルはありません。',
      ...
      installStarted: name => `${name} を追加中...`,
      uninstallStarted: name => `${name} を削除中...`,
  ...
  starmap: {
    ...
    emptyDesc: 'AgentX がスキルやメモリを蓄積すると、ここに表示されます。'
  },
  agents: {
    close: 'エージェントを閉じる',
    title: 'スポーンツリー',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'ペット機能を使うには AgentX を再起動してください。',
      empty: '一致するペットがありません。',
      turnOff: 'オフ',
      turnOn: 'オン',
      installed: 'インストール済み',
    ...
    generatePet: {
      ...
      staleBackend: 'ペットを生成するには AgentX を更新してください。',
      backgroundHint: 'このウィンドウは閉じても大丈夫です。完了したら AgentX が通知します。',
    ...
    hermesActiveSessions: (version, count) => `AgentX ${version} · アクティブセッション ${count}`,
  ...
  messaging: {
    ...
    showMorePlatforms: count => `ほか ${count} 件を表示`,
    step1Title: 'ボットを作成してアクセス権を取得',
    step2Title: 'キーを貼り付け',
    step3Title: 'オンにする',
    step3Enable: name => `オンにすると AgentX が ${name} からのメッセージを受け取ります。`,
    stepDone: '完了',
    restartNow: 'AgentX を再起動',
    recommendedCount: count => `推奨 (${count})`,
    wantsToMessage: (name, platform) => `「${name}」が ${platform} で AgentX と話したがっています`,
    allow: '許可',
    search: 'メッセージングを検索...',
    ...
    states: {
      ...
      disabled: '無効',
      fatal: 'エラー',
      gateway_stopped: 'AgentX のメッセージ連携はオフです',
    ...
    destinationTitle: '会話のアドレス',
    destinationUnavailable: '接続済みですが、このプラットフォームは公開アドレスを提供していません。',
    openDestination: 'アプリで開く',
    viewOnly: '閲覧のみ',
    viewOnlyTitle: platform => `${platform} から追跡中`,
    viewOnlyHint: platform => `${platform} で返信してください。Workmate には進行状況のみが反映されます。`,
  ...
  profiles: {
    ...
    deleting: '削除中...',
    createDesc: 'プロファイルは独立した AgentX 環境です：設定、スキル、SOUL.md が別々になります。',
    nameLabel: '名前',
    cloneFrom: '複製元',
    cloneFromNone: 'なし（空）',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'AgentX はモデルの変更を保存しませんでした。'
    },
    search: 'Cron ジョブを検索...',
    ...
    newCron: '新しい Cron',
    emptyDescNew:
      'Cron 式でプロンプトを実行するスケジュールを設定します。AgentX が実行して、選択した宛先に結果を送信します。',
  ...
  artifacts: {
    pageTitle: 'アーティファクト',
    pageDescription: 'チャットで AgentX が作成した画像・ファイル・リンク。',
    search: 'アーティファクトを検索...',
    refresh: '更新',
    refreshing: '更新中',
    indexing: '最近のチャットからアーティファクトを探しています',
    tabAll: 'すべて',
    tabImages: '画像',
    tabFiles: 'ファイル',
    tabLinks: 'リンク',
    emptyTitle: 'まだアーティファクトはありません',
    emptyDesc: 'AgentX が画像やファイルを作ると、ここに並びます。',
    emptyAction: 'チャットを始める',
    noResultsTitle: '結果がありません',
    noResultsDesc: '現在の絞り込みに一致するものはありません。',
    clearSearch: '検索をクリア',
    showAll: 'すべて表示',
  ...
  sidebar: {
    ...
    projects: {
      ...
      nameFromFolder: 'フォルダー名を使っています。必要なら変更してください。',
      nameRequiredMulti: 'フォルダーが複数あるので、プロジェクト名を付けてください。',
      foldersLabel: 'フォルダ',
      ideaLabel: 'アイデア',
  ...
  composer: {
    ...
    attachUrlDesc: 'AgentX がページを取得し、このターンのコンテキストとして含めます。',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'AgentX にコミットと PR を任せる',
      agentShipPrompt:
  ...
  install: {
    ...
    oneTimeTitle: 'AgentX には一度限りのインストールが必要です',
    ...
    setupChoiceTitle: 'AgentX Workmate Desktop をセットアップ',
    setupChoiceDesc:
      'すでに実行している AgentX ゲートウェイに接続するか、このコンピューターに AgentX をローカルインストールします。',
    connectExistingTitle: '既存の AgentX に接続',
    connectExistingShort: '既存環境に接続',
    connectExistingDesc:
      'セッショントークンまたはブラウザーサインインでリモートバックエンドを使用します。ローカルインストールは開始されません。',
    installLocalTitle: 'AgentX をローカルにインストール',
    installLocalDesc: 'AgentX をダウンロードし、Python 環境を作成して、このコンピューターでバックエンドを実行します。',
    localStartUnavailable:
      'ローカルインストールを開始できません。AgentX Workmate Desktop を再起動して、もう一度お試しください。',
    remoteSetupTitle: '既存の AgentX に接続',
    remoteSetupDesc:
      'ゲートウェイ URL を入力してください。AgentX Workmate Desktop がトークンとブラウザーサインインのどちらが必要かを検出します。',
    remoteUrlTitle: 'ゲートウェイ URL',
    remoteUrlDesc: 'AgentX ゲートウェイのベース URL を使用します。リモートの場合は https:// を含めてください。',
    remoteUrlPlaceholder: 'https://gateway.example.com/agentx',
    probing: 'ゲートウェイ認証方式を検出中...',
    probeError: 'その AgentX ゲートウェイに到達できませんでした。',
    identityProvider: 'ID プロバイダー',
    authTitle: '認証',
    ...
    settingUpTitle: 'AgentX Workmate を設定中',
    finishingTitle: '仕上げ中',
    failedDesc:
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'セルフホスト',
        description:
          'ローカルまたはセルフホストの OpenAI 互換エンドポイント（vLLM、llama.cpp、Ollama など）に AgentX を接続。'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'ブラウザーで確認ページを開きます — AgentX が自動接続します',
    ...
    authorizeThere: 'そこで AgentX を承認してください。',
    copyAuthCode: '認証コードをコピーして以下に貼り付けてください。',
    pasteAuthCode: '認証コードを貼り付け',
    reopenAuthPage: '認証ページを再度開く',
    autoBrowser: provider =>
      `${provider} をブラウザーで開きました。AgentX をそこで承認すれば自動接続されます。コピーや貼り付けは不要です。`,
  ...
  webmate: {
    ...
    onboarding: {
      ...
      stepsEdge: {
        devMode: '開いたページの左下で「開発者モード」をオンにします。',
        drag: '表示されたフォルダーウィンドウから「AgentX WebMate」フォルダーをそのページにドラッグします。または「展開して読み込み」を押してこのフォルダーを選びます。'
      },
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} は ${size} です。AgentX は最初の 512 KB のみを表示します。`,
    ...
    web: {
      ...
      tryAgain: '再試行',
      restarting: 'AgentX を再起動中...',
      askRestart: 'AgentX にサーバーの再起動を依頼',
      lookingRestart: taskId => `AgentX は再起動するプレビューサーバーを検索中です (${taskId})`,
      restartingTitle: 'プレビューサーバーを再起動中',
      restartingMessage: 'AgentX はバックグラウンドで作業中です。進捗はプレビューコンソールで確認してください。',
      ...
      finishedRestarting: message =>
        `AgentX がプレビューサーバーの再起動を完了しました${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'AgentX がサーバーを再起動できませんでした。',
      stillWorking:
        'AgentX はまだ作業中ですが、再起動の結果がまだ届いていません。サーバーコマンドがフォアグラウンドで実行されている可能性があります。',
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'AgentX は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
    sudoPlaceholder: 'sudo パスワード',
    secretTitle: 'シークレットが必要です',
    secretDesc: 'AgentX は続行するための認証情報が必要です。',
  ...
  desktop: {
    ...
    restartToSaveImages: '画像を保存するには AgentX Workmate Desktop を再起動してください',
