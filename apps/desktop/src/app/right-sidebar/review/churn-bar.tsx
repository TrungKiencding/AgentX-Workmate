...
export function ChurnBar({ file }: { file: HermesReviewFile }) {
  ...
  return (
    <span
      aria-hidden
      className="pointer-events-none absolute inset-y-0 right-0 -z-10 block overflow-hidden text-right font-mono text-2xs leading-6 tracking-tight whitespace-nowrap opacity-30 dark:opacity-40"
      style={{
