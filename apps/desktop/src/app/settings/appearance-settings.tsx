...
// baseline; the shipped default is the 125% preset. Ids double as the percent
...
function MarketplaceThemeResults({
  ...
  const search = useQuery({
    ...
    queryFn: () => window.agentxDesktop?.themes?.searchMarketplace(debounced) ?? Promise.resolve([]),
