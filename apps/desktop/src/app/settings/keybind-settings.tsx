    ...
    <div className="group flex items-center gap-2.5 rounded-lg px-2.5 py-1 transition-colors hover:bg-(--chrome-action-hover)">
      ...
      {isDefault ? (
        ...
        <Tip label={k.reset}>
          <button
            aria-label={k.reset}
            className="grid size-6 shrink-0 place-items-center rounded-(--radius-control) text-muted-foreground/70 opacity-0 transition-[opacity,background-color,color] duration-(--dur-short) ease-out hover:bg-(--ui-control-active-background) hover:text-foreground group-hover:opacity-100"
