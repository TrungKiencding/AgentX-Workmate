...
// / Program Files), which buried any files AgentX wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.agentxDesktop` is
    ...
    const settings = window.agentxDesktop?.settings
