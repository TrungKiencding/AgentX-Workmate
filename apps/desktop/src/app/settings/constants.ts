...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  {
    prefix: 'NOUS_',
    name: 'Nous Portal',
    description: 'Hosted AgentX & Nous-trained models',
  ...
  { prefix: 'AGENTX_QWEN_', name: 'DashScope (Qwen)', priority: 6 },
  {
    prefix: 'GLM_',
    name: 'GLM / Z.AI',
...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  ...
  agent: {
    ...
    maxTurns: 'Upper bound for tool-calling turns before AgentX stops a run.'
  },
  terminal: {
  ...
  fileReadMaxChars: 'Maximum characters AgentX can read from one file request.',
  approvals: {
    mode: 'How AgentX handles commands that need explicit approval.',
