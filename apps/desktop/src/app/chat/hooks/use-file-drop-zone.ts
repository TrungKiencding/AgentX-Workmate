...
import { type DroppedFile, extractDroppedFiles, AGENTX_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, AGENTX_PATHS_MIME) ? 'files' : null
