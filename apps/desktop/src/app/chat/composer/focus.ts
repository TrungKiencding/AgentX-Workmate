...
const FOCUS_EVENT = 'agentx:composer-focus'
const INSERT_EVENT = 'agentx:composer-insert'
const INSERT_REFS_EVENT = 'agentx:composer-insert-refs'
const SUBMIT_EVENT = 'agentx:composer-submit'
const VOICE_TOGGLE_EVENT = 'agentx:composer-voice-toggle'
const MODEL_MENU_EVENT = 'agentx:composer-model-menu'
