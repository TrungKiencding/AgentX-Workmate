          ...
          >
            ...
            <div className="relative w-full rounded-[inherit]">
              ...
              >
                ...
                <div
                  className={cn(
                    'relative z-1 flex min-h-0 w-full flex-col gap-(--composer-row-gap) overflow-hidden rounded-[inherit] px-(--composer-surface-pad-x) py-(--composer-surface-pad-y) transition-opacity duration-(--dur-short) ease-out',
                    scrolledUp
