  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2">
        ...
        <span className="font-mono text-2xs text-muted-foreground/85">{formatElapsed(state.elapsedSeconds)}</span>
      </div>
...
export function VoicePlaybackActivity() {
  ...
  return (
    ...
    >
      ...
      <Button className="shrink-0 rounded-full" onClick={stopVoicePlayback} size="xs" type="button" variant="ghost">
