...
// by main.ts (`setBackgroundThrottling` driven by the merged `agentx:active-work`
...
// (the "AgentX idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey AgentX" wake word has NO preceding click,
