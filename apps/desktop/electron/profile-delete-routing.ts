// Profile-delete routing logic for the `agentx:api` IPC handler.
//
...
/**
 * Parse a `agentx:api` request into the profile name a DELETE targets, or
...
/**
 * Route the next `agentx:api` request away from the primary/window backend
