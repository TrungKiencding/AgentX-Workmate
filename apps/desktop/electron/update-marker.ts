...
export function markerPath(hermesHome) {
  return path.join(hermesHome, '.agentx-update-in-progress')
}
 ...
 *
 * The Tauri-based agentx-setup.exe takes several seconds to initialise its
 ...
 * AgentX to exit…") clobbers that still-running updater's claim: the
