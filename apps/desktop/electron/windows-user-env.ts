...
// even though a fresh shell — and the AgentX CLI — sees it immediately. The
// desktop's AGENTX_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\agentx. Reading
...
//       AGENTX_HOME    REG_SZ    F:\AgentX Workmate\data
//
