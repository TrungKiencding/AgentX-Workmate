...
contextBridge.exposeInMainWorld('agentxDesktop', {
  ...
  statPath: targetPath => ipcRenderer.invoke('agentx:fs:stat', targetPath),
  saveFileCopy: targetPath => ipcRenderer.invoke('agentx:fs:saveCopy', targetPath),
  quickLookPath: targetPath => ipcRenderer.invoke('agentx:fs:quickLook', targetPath),
