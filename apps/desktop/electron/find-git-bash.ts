 ...
 *   1. AGENTX_GIT_BASH_PATH env var override
 *   2. PortableGit under %LOCALAPPDATA%\agentx\git\ (install.ps1)
...
export function findGitBash(opts: GitBashOptions): string | null {
  ...
  // Respect AGENTX_GIT_BASH_PATH if set (mirrors tools/environments/local.py:_find_bash).
  const gitBashPath = env.AGENTX_GIT_BASH_PATH
