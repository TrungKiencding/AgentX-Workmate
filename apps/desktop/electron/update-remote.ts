 ...
 *
 * A public install can end up with `origin=git@github.com:AstralX/agentx-workmate.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/AstralX/agentx-workmate.git'
// Lowercased: canonicalGitHubRemote() lowercases its result, so a
// mixed-case constant here can never compare equal.
const OFFICIAL_REPO_CANONICAL = 'github.com/astralx/agentx-workmate'
