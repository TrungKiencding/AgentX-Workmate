 ...
 *
 * A public install can end up with `origin=git@github.com:TrungKiencding/AgentX-Workmate.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/TrungKiencding/AgentX-Workmate.git'
// Lowercased: canonicalGitHubRemote() lowercases its result, so a
// mixed-case constant here can never compare equal.
const OFFICIAL_REPO_CANONICAL = 'github.com/trungkiencding/agentx-workmate'
