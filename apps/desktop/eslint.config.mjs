...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @agentx/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@agentx/shared'],
              message: 'Plugins import only @agentx/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
