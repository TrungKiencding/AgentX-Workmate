#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from AgentX logs.
...
With no LOGFILE, reads ``$AGENTX_HOME/logs/agent.log`` (default ~/.agentx).
...
def default_log() -> Path:
    home = os.environ.get("AGENTX_HOME") or str(Path.home() / ".agentx")
