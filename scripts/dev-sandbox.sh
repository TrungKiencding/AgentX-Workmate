...
INSTALL_REF=""
UPSTREAM_URL="${AGENTX_DEV_SANDBOX_UPSTREAM:-https://github.com/NousResearch/hermes-agent.git}"
...
GIT_ROOT="${AGENTX_SANDBOX_SOURCE_ROOT:-$(git rev-parse --show-toplevel)}"
