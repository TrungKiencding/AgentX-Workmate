#!/usr/bin/env python3
"""Build the AgentX Skills Index — a centralized JSON catalog of all skills.
...
`agentx skills search/install` can use it without hitting the GitHub API.
...
# Ensure AGENTX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building AgentX Skills Index...", flush=True)
