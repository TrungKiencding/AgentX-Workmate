#!/usr/bin/env python3
"""Build the AgentX Model Catalog — a centralized JSON manifest of curated models.
...
# Ensure AGENTX_HOME is set for imports that touch it at module level.
os.environ.setdefault("AGENTX_HOME", os.path.join(os.path.expanduser("~"), ".agentx"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://github.com/TrungKiencding/AgentX-Workmate/blob/main/website/docs/reference/model-catalog.md",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model AgentX '
