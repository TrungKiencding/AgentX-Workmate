#!/usr/bin/env python3
"""
SWE Runner with AgentX Trajectory Format

A runner that uses AgentX-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the AgentX-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses AgentX-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in AgentX format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches AgentX-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using AgentX-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with AgentX Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses AgentX-Agent's built-in execution environments
    and outputs trajectories in AgentX-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to AgentX trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to AgentX trajectory format
...
def main(
    ...
    """
    Run SWE tasks with AgentX trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with AgentX Trajectory Format")
    print("=" * 60)
