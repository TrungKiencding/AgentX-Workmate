...
benchmarked ten harnesses on hostile-file handling — and whose AgentX column
...
Every task runs the full AgentX agent (file + terminal + search toolsets)
...
Rules of engagement (from agentxbench discipline):
