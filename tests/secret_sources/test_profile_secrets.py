...
def _apply(secrets, cfg_extra=None, home=Path("/tmp/x/.agentx"), env=None):
...
PROFILE_HOME = Path("/home/u/.agentx/profiles/milla")
...
def test_hyphenated_profile_name_matches_underscore_suffix():
    _, env = _apply(
        ...
        home=Path("/home/u/.agentx/profiles/my-bot"),
    )
