...
def store(tmp_path, monkeypatch):
    ...
    ~/.agentx/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hermes_state import time, before pytest's AGENTX_HOME monkeypatch
    fires — the autouse fixture's AGENTX_HOME override doesn't help here.)
    """
    import hermes_state
