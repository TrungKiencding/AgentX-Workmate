...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("AGENTX_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("AGENTX_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("AGENTX_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
