...
def test_record_repos_persists_and_shows_zero_session_repo(tmp_path):
    ...
    # Repo-first: a scanned repo with no agentx sessions still surfaces.
...
def test_scan_time_is_not_treated_as_session_activity(tmp_path):
    ...
    in AgentX outranked the ones they actually work in.
    """
...
def test_terminal_session_persists_its_launch_cwd():
    ...
    The user cd'd into that directory before running agentx. Dropping it left
