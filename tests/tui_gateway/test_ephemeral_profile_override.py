"""Regression tests: profile AGENTX_HOME override in ephemeral agent threads (#50233).
...
``AGENTX_HOME`` ContextVar set on the session-create thread does NOT propagate to
...
PROFILE_HOME = "/home/user/.agentx/profiles/work"
