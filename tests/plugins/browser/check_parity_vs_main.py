...
Run from the PR worktree:
    ...
    cd ~/.agentx/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.agentx/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.agentx/hermes-agent
