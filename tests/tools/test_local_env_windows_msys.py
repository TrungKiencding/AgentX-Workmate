...
class TestBashSafePath:
    ...
    def test_quote_bash_path_quotes_mixed_windows_path(self, monkeypatch):
        ...
        quoted = _quote_bash_path(
            r"C:\Users\Alexander\AppData\Local\Temp\agentx-snap-abc.sh"
        )
        assert "/c/Users/Alexander/AppData/Local/Temp/agentx-snap-abc.sh" in quoted
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_rewrites_backslash_snapshot_paths(self, monkeypatch):
        ...
        snap = r"C:\Users\Alexander\AppData\Local\Temp\agentx-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/AppData/Local/Temp/agentx-snap-deadbeef.sh" in script
