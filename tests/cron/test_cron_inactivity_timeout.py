...
- Unlimited timeout (AGENTX_CRON_TIMEOUT=0)
- Backward compat: AGENTX_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """AGENTX_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
    ...
    def test_timeout_env_var_parsing(self, monkeypatch):
        """AGENTX_CRON_TIMEOUT env var is respected."""
        monkeypatch.setenv("AGENTX_CRON_TIMEOUT", "1200")
