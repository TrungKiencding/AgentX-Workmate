...
class TestRunJobTerminalCwd:
    ...
    def _install_stubs(monkeypatch, observed: dict):
        ...
        # Bypass the real provider resolver — it reads ~/.agentx and credentials.
        ...
        monkeypatch.setenv("AGENTX_CRON_TIMEOUT", "0")

        # run_job calls load_dotenv(~/.agentx/.env, override=True), which will
