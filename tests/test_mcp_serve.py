"""
Tests for mcp_serve — AgentX MCP server.
...
def _isolate_hermes_home(tmp_path, monkeypatch):
    """Redirect AGENTX_HOME to a temp directory."""
...
class TestEventBridgePollE2E:
    ...
    def test_poll_picks_up_new_conversation_on_db_change(
        ...
        # _poll_once reads <AGENTX_HOME>/state.db for its mtime gate; the autouse
        # fixture points AGENTX_HOME at tmp_path.
        db_path = tmp_path / "state.db"
