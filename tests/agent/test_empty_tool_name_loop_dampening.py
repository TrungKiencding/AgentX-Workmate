...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated AGENTX_HOME, yield (agent, helpers)."""
    ...
    os.makedirs(os.path.join(test_home, ".agentx"))
    prev_home = os.environ.get("AGENTX_HOME")
    os.environ["AGENTX_HOME"] = os.path.join(test_home, ".agentx")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["AGENTX_HOME"] = prev_home
