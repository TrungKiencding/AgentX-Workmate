"""Runtime smoke test for Docker $AGENTX_HOME/logs/gateways seeding.

Build the real image and verify logs/ and logs/gateways/ exist and are
owned by the agentx user after container boot.
...
registered later runs its log service as the dropped agentx user and
...
def test_logs_gateways_seeded_and_hermes_owned(
    ...
    """logs/ and logs/gateways/ must exist and be owned by agentx after boot."""
