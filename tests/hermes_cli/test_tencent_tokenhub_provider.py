...
# =============================================================================
# CANONICAL_PROVIDERS (agentx model picker)
# =============================================================================
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in AGENTX_OVERLAYS
        overlay = AGENTX_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from hermes_cli.providers import AGENTX_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = AGENTX_OVERLAYS["tencent-tokenhub"]
