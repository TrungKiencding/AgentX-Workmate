"""Tests for agentx claw commands."""
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.agentx/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.agentx/memories/MEMORY.md"},
