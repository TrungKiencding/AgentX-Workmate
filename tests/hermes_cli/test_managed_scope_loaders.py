...
def test_timezone_honors_managed(homes, monkeypatch):
    ...
    monkeypatch.delenv("AGENTX_TIMEZONE", raising=False)
...
def test_gateway_env_bridge_honors_managed(homes, monkeypatch):
    ...
    every turn (AGENTX_TIMEZONE, AGENTX_REDACT_SECRETS, AGENTX_MAX_ITERATIONS,
    ...
    # writing AGENTX_TIMEZONE = cfg["timezone"]. Prove the overlay flips the value.
    import yaml
