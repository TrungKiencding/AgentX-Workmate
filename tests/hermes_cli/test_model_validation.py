...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send an AgentX User-Agent.
    ...
    def test_probe_sends_hermes_user_agent(self):
        ...
        assert ua.startswith("agentx-cli/"), (
            f"User-Agent must advertise agentx-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("agentx-cli/")
