"""Tests for the Command Installation check in agentx doctor."""
...
def _setup_doctor_env(monkeypatch, tmp_path, venv_name="venv"):
    """Create a minimal AGENTX_HOME + PROJECT_ROOT for doctor tests."""
    ...
    hermes_bin = venv_bin_dir / "agentx"
