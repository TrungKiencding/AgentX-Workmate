"""Tests for `agentx chat --safe-mode` isolation."""
...
_VARS = ("AGENTX_SAFE_MODE", "AGENTX_IGNORE_USER_CONFIG", "AGENTX_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["AGENTX_SAFE_MODE"] == "1"
        assert os.environ["AGENTX_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["AGENTX_IGNORE_RULES"] == "1"
        return True
