...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and agentx-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # agentx-agent (tests/skills/)
]
