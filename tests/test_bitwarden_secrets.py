...
binary download are exercised manually by `agentx secrets bitwarden
...
def hermes_home(tmp_path, monkeypatch):
    """Point AgentX at an isolated home directory."""
    home = tmp_path / ".agentx"
    home.mkdir()
    monkeypatch.setenv("AGENTX_HOME", str(home))
    # Some modules cache get_hermes_home; clear if needed.
    import hermes_constants
    if hasattr(hermes_constants, "_AGENTX_HOME_CACHE"):
        hermes_constants._AGENTX_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
