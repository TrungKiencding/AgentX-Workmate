...
All per-subject data lives under PDD_DATA_DIR (default: $AGENTX_HOME/unbroker),
which is the same trust boundary AgentX uses for .env and OAuth tokens.
"""
...
def hermes_home() -> Path:
    return Path(os.environ.get("AGENTX_HOME") or (Path.home() / ".agentx"))
