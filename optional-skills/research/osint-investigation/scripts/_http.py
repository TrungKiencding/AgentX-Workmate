...
DEFAULT_UA = (
    "agentx-osint-investigation/0.2 "
    "(+https://github.com/AstralX/agentx-workmate; "
    "set AGENTX_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("AGENTX_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
