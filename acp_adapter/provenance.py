...
This is an additive AgentX extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal AgentX head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal AgentX DB session id
