...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Nous Research Discord](https://discord.gg/NousResearch). Users can install it with `agentx skills install`.
...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.agentx/plugins/`, project `.agentx/plugins/`, or a pip entry point) — see [Build a AgentX Plugin](https://hermes-agent.nousresearch.com/docs/guides/build-a-agentx-plugin)
