...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.agentx/plugins/`, project `.agentx/plugins/`, or a pip entry point) — see [Build a AgentX Plugin](https://hermes-agent.nousresearch.com/docs/guides/build-a-hermes-plugin)
