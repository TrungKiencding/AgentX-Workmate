...
# optimized via ``agentx sessions optimize-storage``. A legacy DB sits at
...
# `agentx sessions optimize-storage` rebuilds it on a capable host.
...
# triggers repairable UNTIL the user opts into `agentx db optimize`. This is
