...
def auth_json_path():
    """Return the AgentX auth store path, respecting AGENTX_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`agentx tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is an AgentX release, and
