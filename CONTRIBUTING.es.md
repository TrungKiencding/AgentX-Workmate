...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [GitHub Discussions](https://github.com/AstralX/agentx-workmate/discussions). Los usuarios pueden instalarla con `agentx skills install`.
...
- Usa [GitHub Issues](https://github.com/AstralX/agentx-workmate/issues)
...
- **Discussions**: [GitHub Discussions](https://github.com/AstralX/agentx-workmate/discussions) — para preguntas, mostrar proyectos y compartir habilidades
