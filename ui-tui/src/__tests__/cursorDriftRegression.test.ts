 ...
 *
 * Symptom: in `agentx --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@agentx/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using agentx --tui and as i type multiline my caret at the end will often ' +
