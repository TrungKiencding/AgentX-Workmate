import { Box, type ScrollBoxHandle, stringWidth, Text } from '@agentx/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (AGENTX_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (AGENTX_DEV_CREDITS), lowest priority,
