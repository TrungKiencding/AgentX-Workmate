...
import type { ScrollBoxHandle } from '@agentx/ink'
import { evictInkCaches } from '@agentx/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.AGENTX_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
