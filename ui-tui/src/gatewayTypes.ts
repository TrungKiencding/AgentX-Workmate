import type { BillingBlock, UsageModelData } from '@agentx/shared/billing'
import type { HermesSkin } from '@agentx/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@agentx/shared`).
...
// Wire shapes now live in @agentx/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
