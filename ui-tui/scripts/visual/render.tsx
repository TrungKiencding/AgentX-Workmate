 ...
 * across theme x background scenes to <tmpdir>/agentx-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@agentx/ink'
...
const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/agentx-agent',
...
const setup = (bgHex: string) => {
  process.env.AGENTX_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
