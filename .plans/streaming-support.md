# Streaming LLM Response Support for AgentX Workmate
...
```
AGENTX_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("AGENTX_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
