    ...
    if quiet_mode:
        ...
        if profile_scope != CHECK_FN_CACHE_BYPASS:
            cache_key = (
                ...
                cfg_fp,
                bool(os.environ.get("AGENTX_KANBAN_TASK")),
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        if (
            ...
            # Dispatcher-spawned workers are scoped by AGENTX_KANBAN_TASK and
    ...
    # This ensures that even if a composite toolset (like agentx-cli)
    ...
    if disabled_toolsets:
        for toolset_name in disabled_toolsets:
            if validate_toolset(toolset_name):
                ...
                if toolset_name.startswith("agentx-") or (get_toolset(toolset_name) or {}).get("posture"):
                    # Platform bundles (agentx-*) include _AGENTX_CORE_TOOLS, and
                    ...
                    if (not quiet_mode and toolset_name.startswith("agentx-")
    ...
    # window). Core AgentX tools (toolsets._AGENTX_CORE_TOOLS) are NEVER
