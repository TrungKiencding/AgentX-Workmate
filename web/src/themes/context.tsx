...
const STORAGE_KEY = "agentx-dashboard-theme";
...
const FONT_STORAGE_KEY = "agentx-dashboard-font";
...
const CUSTOM_CSS_STYLE_ID = "agentx-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-agentx-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-agentx-theme-font", "true");
