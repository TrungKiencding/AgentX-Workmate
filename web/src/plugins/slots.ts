 ...
 * `window.__AGENTX_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the AgentX brand in the top bar
 ...
 *  `window.__AGENTX_PLUGINS__.registerSlot(...)`.
 *
