 ...
 *
 * Plugins call window.__AGENTX_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__AGENTX_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__AGENTX_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__AGENTX_PLUGIN_SDK__ = {
    ...
    // window.__AGENTX_SESSION_TOKEN__ directly.
    authedFetch,
