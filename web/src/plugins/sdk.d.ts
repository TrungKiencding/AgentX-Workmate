 ...
 * ``window.__AGENTX_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__AGENTX_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@agentx/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__AGENTX_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__AGENTX_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__AGENTX_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __AGENTX_PLUGIN_SDK__?: HermesPluginSDK;
    __AGENTX_PLUGINS__?: PluginRegistry;
  }
}
