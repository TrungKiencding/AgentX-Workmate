...
def render_skill_page(
    ...
    hermes_meta = (fm.get("metadata") or {}).get("agentx") or {}
...
def build_catalog_md_optional(entries: list[tuple[dict[str, Any], dict[str, Any]]]) -> str:
    ...
    lines = [
        ...
        'description: "Official optional skills shipped with hermes-agent — install via agentx skills install official/<category>/<skill>"',
        "---",
        "",
