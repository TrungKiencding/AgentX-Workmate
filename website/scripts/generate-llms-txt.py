#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the AgentX docs site.
...
Both publish at:
  https://raw.githubusercontent.com/TrungKiencding/AgentX-Workmate/main/website/static/llms.txt
  https://raw.githubusercontent.com/TrungKiencding/AgentX-Workmate/main/website/static/llms-full.txt
...
SITE_BASE = "https://github.com/TrungKiencding/AgentX-Workmate/tree/main/website/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use AgentX as a Python Library", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with AgentX"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# AgentX Workmate")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by AstralX Technology. A terminal-native "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/TrungKiencding/AgentX-Workmate")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# AgentX Workmate — Full Documentation\n",
        (
            "This file is the entire AgentX Workmate documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using AgentX, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://github.com/TrungKiencding/AgentX-Workmate/tree/main/website/docs\n",
        "Short index: https://raw.githubusercontent.com/TrungKiencding/AgentX-Workmate/main/website/static/llms.txt\n",
        "\n---\n\n",
    ]
