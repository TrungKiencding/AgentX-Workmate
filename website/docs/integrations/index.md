...
- **[Plugin System](/user-guide/features/plugins)** — Extend Hermes with custom tools, lifecycle hooks, and CLI commands without modifying core code. Plugins are discovered from `~/.agentx/plugins/`, project-local `.agentx/plugins/`, and pip-installed entry points.
