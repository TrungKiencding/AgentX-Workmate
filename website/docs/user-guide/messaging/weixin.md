...
| Terminal QR code doesn't render | Reinstall with the messaging extra: `cd ~/.agentx/hermes-agent && uv pip install -e ".[messaging]"`. Alternatively, open the URL printed above the QR |
