...
In Raft, open the Agents menu, create an External Agent, and follow the setup card to install the Raft CLI and log in the agent profile. Once the agent is created, Raft shows a AgentX setup guide with the environment variables and configuration needed to start the gateway.
