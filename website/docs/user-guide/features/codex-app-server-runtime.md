...
If you find a bug, [open an issue](https://github.com/AstralX/agentx-workmate/issues) with the output of `agentx logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
