...
hermes curator list-archived    # list skills currently in ~/.agentx/skills/.archive/
...
Before every real curator pass, Hermes takes a tar.gz snapshot of `~/.agentx/skills/` at `~/.agentx/skills/.curator_backups/<utc-iso>/skills.tar.gz`. If a pass archives or consolidates something you didn't want touched, you can undo the whole run with one command:
