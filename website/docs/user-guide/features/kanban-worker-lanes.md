...
- [`KANBAN_GUIDANCE`](https://github.com/AstralX/agentx-workmate/blob/main/agent/prompt_builder.py) — the worker + orchestrator lifecycle injected into every kanban worker's system prompt.
