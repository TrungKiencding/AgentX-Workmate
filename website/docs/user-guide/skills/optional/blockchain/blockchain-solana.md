...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/blockchain/solana` |
...
Helper script path: ~/.agentx/skills/blockchain/solana/scripts/solana_client.py
