...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/productivity/canvas` |
...
4. Name the token (e.g., "AgentX Workmate"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${AGENTX_HOME:-~/.agentx}/.env`:
