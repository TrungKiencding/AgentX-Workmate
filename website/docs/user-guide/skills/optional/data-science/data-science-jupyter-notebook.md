...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing agentx tool access (web_search, file ops). Stateless. |
