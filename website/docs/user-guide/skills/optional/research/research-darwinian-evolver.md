...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/research/darwinian-evolver` |
...
import upstream classes into AgentX itself.
...
Open `~/.agentx/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside AgentX core.
   Custom driver scripts under `~/.agentx/skills/...` are user-side and fine.
