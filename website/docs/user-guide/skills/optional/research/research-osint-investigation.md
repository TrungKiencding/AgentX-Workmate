...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/research/osint-investigation` |
...
# $AGENTX_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set AGENTX_OSINT_UA=your-app/1.0 (your@email) to identify yourself
