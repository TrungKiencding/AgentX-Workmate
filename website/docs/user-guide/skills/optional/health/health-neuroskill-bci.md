...
| | |
|---|---|
| Source | Optional — install with `agentx skills install official/health/neuroskill-bci` |
...
Connect AgentX to a running [NeuroSkill](https://neuroskill.com/) instance to read
