...
Set your Tenor API key in your environment (add to `${AGENTX_HOME:-~/.agentx}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/TrungKiencding/AgentX-Workmate/blob/main/skills/media/gif-search/url)`
