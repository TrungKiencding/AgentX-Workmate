---
title: "Webmate — Delegate browser tasks to the signed-in AgentX WebMate"
sidebar_label: "Webmate"
...
Delegate browser tasks to the signed-in AgentX WebMate.
...
| Path | `skills/autonomous-ai-agents/webmate` |
| Version | `1.1.0` |
| Author | AstralX Technology |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Browser`, `AgentX-WebMate`, `MCP`, `Delegation`, `Signed-In-Session`, `SSO`, `Webmail`, `Dashboards` |
| Related skills | [`agentx-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-agentx-agent), [`computer-use`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-computer-use) |
