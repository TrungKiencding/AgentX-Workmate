...
:::warning
This permanently deletes the profile's entire directory including all config, memories, sessions, and skills. The `default` profile (`~/.agentx`) cannot be deleted — use `hermes uninstall` to remove everything.
:::
