...
| `AGENTX_DESKTOP_AGENTX_ROOT` | Desktop source-checkout override used by `agentx desktop --hermes-root`; checked before the packaged first-launch install or an existing `agentx` on `PATH`. |
