...
| `kanban_attach_url` | Attach a file to a task by URL — Hermes downloads it server-side and stores it as a real attachment (capped at 25 MB). Only http/https URLs. | `AGENTX_KANBAN_TASK` or `kanban` toolset |
