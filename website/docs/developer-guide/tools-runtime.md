...
AgentX tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. AgentX resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`agentx-cli`, `agentx-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `agentx-acp`
