...
- **Profile-safe paths**: Never hardcode `~/.agentx` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/AstralX/agentx-workmate/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discussions**: [GitHub Discussions](https://github.com/AstralX/agentx-workmate/discussions)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/AstralX/agentx-workmate/blob/main/LICENSE).
