...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to AgentX Workmate — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to AgentX Workmate! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying AgentX core? Start with [Build an AgentX Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for AgentX itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated AgentX instance (throwaway AGENTX_HOME, separate Electron
...
- **Profile-safe paths**: Never hardcode `~/.agentx` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/TrungKiencding/AgentX-Workmate/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discussions**: [GitHub Discussions](https://github.com/TrungKiencding/AgentX-Workmate/discussions)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/TrungKiencding/AgentX-Workmate/blob/main/LICENSE).
