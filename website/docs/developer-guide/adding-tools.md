...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to AgentX Workmate — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in AgentX tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying AgentX core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build an AgentX Plugin](/developer-guide/plugins)
...
2. **`toolsets.py`** — add tool name to `_AGENTX_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `agentx chat -q "Use the weather tool for London"`
