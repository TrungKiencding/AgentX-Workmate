...
* Implementation: [`agent/plugin_llm.py`](https://github.com/AstralX/agentx-workmate/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/AstralX/agentx-workmate/blob/main/tests/agent/test_plugin_llm.py)
