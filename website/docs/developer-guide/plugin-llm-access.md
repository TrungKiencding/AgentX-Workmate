...
* Implementation: [`agent/plugin_llm.py`](https://github.com/TrungKiencding/AgentX-Workmate/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/TrungKiencding/AgentX-Workmate/blob/main/tests/agent/test_plugin_llm.py)
