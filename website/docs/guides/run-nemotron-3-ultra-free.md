...
[Download the AgentX Workmate Desktop installer](https://github.com/AstralX/agentx-workmate) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://raw.githubusercontent.com/AstralX/agentx-workmate/main/scripts/install.sh), inspect it, then run it.
