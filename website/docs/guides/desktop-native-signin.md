...
description: "How the AgentX Workmate Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the AgentX Workmate Desktop app connects to a **gated gateway** (a hosted or
...
For AgentX specifically, native sign-in means:
...
- [Run AgentX with Nous Portal](./run-agentx-with-nous-portal.md)
