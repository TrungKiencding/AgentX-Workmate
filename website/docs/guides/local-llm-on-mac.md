...
AGENTX_STREAM_READ_TIMEOUT=1800
```

| Timeout | Default | Local auto-adjustment | Env var override |
|---------|---------|----------------------|------------------|
| Stream read (socket-level) | 120s | Raised to 1800s | `AGENTX_STREAM_READ_TIMEOUT` |
| Stale stream detection | 180s | Disabled entirely | `AGENTX_STREAM_STALE_TIMEOUT` |
| API call (non-streaming) | 1800s | No change needed | `AGENTX_API_TIMEOUT` |
