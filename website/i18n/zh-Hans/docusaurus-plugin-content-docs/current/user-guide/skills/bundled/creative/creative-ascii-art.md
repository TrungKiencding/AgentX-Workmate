...
```bash
python3 -m pyfiglet "AGENTX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AGENTX&font=Slant" | boxes -d stone
```
