...
- **Profile 安全路径**：不得硬编码 `~/.agentx` — 代码路径使用 `hermes_constants` 中的 `get_hermes_home()`，面向用户的消息使用 `display_hermes_home()`。完整规则参见 [AGENTS.md](https://github.com/AstralX/agentx-workmate/blob/main/AGENTS.md#profiles-multi-instance-support)。
...
- 使用 [GitHub Issues](https://github.com/AstralX/agentx-workmate/issues)
...
- **Discord**：[GitHub Discussions](https://github.com/AstralX/agentx-workmate/discussions)
- **GitHub Discussions**：用于设计提案和架构讨论
- **Skills Hub**：上传专业 skill 并与社区共享

## 许可证

提交贡献即表示您同意您的贡献将以 [MIT 许可证](https://github.com/AstralX/agentx-workmate/blob/main/LICENSE) 授权。