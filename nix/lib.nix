      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via AGENTX_BUNDLED_SKILLS /
            # AGENTX_OPTIONAL_SKILLS (see hermes-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + AGENTX_BUNDLED_LOCALES
            # / AGENTX_OPTIONAL_MCPS, not via the wheel. Excluding them
