"""Core NeMo Relay adapters for physical AgentX provider attempts."""
...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited AgentX turn when present."""
...
def stream_current(
    ...
    *,
    ...
    """Run a provider stream under the inherited AgentX turn when present.
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from AgentX's provider worker thread."""
...
class AnthropicStreamAccumulator:
    ...
    def response(self, base: Any = None) -> Any:
        """Return the attribute-shaped response consumed by AgentX."""
