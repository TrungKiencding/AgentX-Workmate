...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Agentx-Session-Id header), and an
        ...
        if env_var_enabled("AGENTX_DUMP_REQUEST_STDOUT"):
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # Delegate all rate-limit / 5xx retry to agentx's outer conversation loop,
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    #
    # We do NOT drop the call: agentx' own dispatch loop intentionally keeps an
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    AgentX' keepalive client (#10324 / ``_build_keepalive_http_client``) and
