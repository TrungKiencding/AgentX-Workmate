"""AWS Bedrock Converse API adapter for AgentX Workmate.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install AgentX with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When AgentX is installed editable into system Python, the system boto3
