...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``agentx logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # AgentX only initiates compaction in "agentx" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping AgentX preflight compression for codex app-server "
                "(mode=%s); AgentX will not start thread compaction here.",
