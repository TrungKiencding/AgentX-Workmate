"""Core NeMo Relay adapter for AgentX tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the AgentX tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous AgentX Relay tool execution cannot run on an active event-loop thread"
    )
