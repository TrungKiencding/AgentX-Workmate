...
def _provision_managed_npm(npm_range: str | None, *, quiet: bool = False) -> str | None:
    """Provision a AgentX-managed Node tree and return a satisfying npm.
    ...
    if not quiet:
        print(
            "→ Provisioning a AgentX-managed Node.js runtime "
...
def maybe_repair_npm_engine(
    ...
    *output* is the combined stdout/stderr of the npm command that just failed.
    ...
    the same *npm* after an in-place upgrade of a AgentX-managed install, or
