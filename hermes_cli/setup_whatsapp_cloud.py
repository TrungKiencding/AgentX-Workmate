...
Entry point: ``agentx whatsapp-cloud`` (dispatched from
...
AgentX gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures AgentX to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  AgentX needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the AgentX gateway in another terminal:")
    print("         agentx gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/TrungKiencding/AgentX-Workmate/tree/main/website/docs")
