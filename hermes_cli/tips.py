...
TIPS = [
    ...
    "Hermes loads project context from .agentx.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "Profiles scope Hermes state via AGENTX_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
