"""``agentx tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'agentx tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # agentx tools list [--platform cli]
    ...
    # agentx tools disable <name...> [--platform cli]
    ...
    # agentx tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `agentx tools` runs after you pick a provider that\n"
