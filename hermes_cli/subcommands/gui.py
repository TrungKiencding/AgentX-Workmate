...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description=(
            "Launch the AgentX Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets AGENTX_DESKTOP_CWD)",
    )
    gui_parser.add_argument(
        "--skip-build",
        action="store_true",
