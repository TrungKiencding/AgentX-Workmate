"""
AgentX CLI - Unified command-line interface for AgentX Workmate.

Provides subcommands for:
- agentx chat          - Interactive chat (same as ./agentx)
- agentx gateway       - Run gateway in foreground
- agentx gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `agentx setup` on a fresh Pi.
