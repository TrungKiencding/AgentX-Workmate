"""AgentX middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "agentx.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "agentx.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before AgentX sends them.
    """
