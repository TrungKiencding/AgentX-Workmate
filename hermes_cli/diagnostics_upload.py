"""Client for uploading ``agentx debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``agentx debug share``.
...
NAS_BASE = os.environ.get(
    "AGENTX_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "agentx-agent/debug-share"
