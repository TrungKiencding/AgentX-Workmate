...
Used by ``agentx kanban specify [task_id | --all]``. Takes a task that
...
AGENTX_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("AGENTX_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the AgentX Workmate board.
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=AGENTX_KANBAN_SPECIFY_MAX_TOKENS,
