...
Used by ``agentx profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the AgentX Workmate kanban board.
...
Rules:
  ...
  - Never write "AgentX Workmate profile" or other meta-narration.
