...
_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $AGENTX_HOME/node is
...
def _has_hermes_agent_browser() -> bool:
    ...
    # install.sh installs globally into $AGENTX_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-AgentXHome", str(get_hermes_home()),
        ]
    else:
